...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			path: '/shop/collection/left/sidebar', title: 'Products', type: 'link', active: false
		},
		{
			path: '/shop/product/three/column/trim-dress', title: 'Product 2nd', type: 'link', active: false,
		},
		{
			title: 'pages', type: 'sub', active: false, children: [
				...
				{ path: '/pages/compare/two', title: 'compare', type: 'link' },
